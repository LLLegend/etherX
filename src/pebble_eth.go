...
func openKeyValueDatabase(o OpenOptions) (*Database, error) {
...
func NewPebbleDBDatabase(file string, cache int, handles int, namespace string, readonly, ephemeral bool) (*Database, error) {
	db, err := New(file, cache, handles, namespace, readonly, ephemeral)
	if err != nil {
		return nil, err
	}
	return db, nil
